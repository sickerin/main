...
public class ModelManagerTest {
    ...
    public void setUserPrefs_validUserPrefs_copiesUserPrefs() {
        ...
        userPrefs.setAddressBookFilePath(Paths.get("giatros/book/file/path"));
        ...
        userPrefs.setAddressBookFilePath(Paths.get("new/giatros/book/file/path"));
    ...
    public void setAddressBookFilePath_validPath_setsAddressBookFilePath() {
        Path path = Paths.get("giatros/book/file/path");
