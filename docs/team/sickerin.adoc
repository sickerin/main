...
One of the main features of Giatros is its ability to track various appointments for each patient, something that medical professionals often overlook. This may lead to tragedy, such as death
due to drug allergy, as seen in this https://www.straitstimes.com/singapore/courts-crime/womans-death-from-drug-allergy-found-to-be-a-medical-misadventure[news article]. Moreover, hospitals have a large number of patients, thereby staff can be easily overwhelmed, thus requiring a systematic way to make and manage appointments for instance. 
