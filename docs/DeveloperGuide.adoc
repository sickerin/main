...
* Pharmacists
** Decide what kind of medication should be prescribed, taking into consideration the patient’s allergy
* Doctors
** Decide what kind of treatment works best for a particular patient, and give a more personalised treatment
** Manage his or her time well by knowing when exactly are their patient appointments
...
|`* * *` |doctor |add a patient’s allergy |make sure that proper treatment and medication can be given to the patient

|`* * *` |doctor |edit a patient’s allergy |update the patient’s allergy data

|`* * *` |doctor |delete a patient’s allergy |remove an allergy that has been erroneously input or mysteriously cured

|`* * *` |pharmacist |check a patient’s allergy |give out the proper medication
...
|`* *` |doctor |check a patient’s appointment |better allocate my timetable

|`*` |receptionist |the search result to be shown neatly |locate and process work faster

|`*` |doctor |all my upcoming appointments to be displayed in a dashboard |keep track of all my appointments

|`*` |doctor |view room booking |find out where the treatment is being delivered

|`*` |pharmacist |have a drug inventory feature |keep track of the drug inventory status
|=======================================================================
